...
<div id="myModal" class="modal">
    ...
    <div class="modal-content" style="margin-top: -60px">
        <div class="modal-header">
            ...
            <h2 id="popupHead">Enter actor</h2>
        </div>
        <div class="modal-body" >
            <div style="display:none" id="addTeacherForm">
                <form action="actorsval.php" method="POST">
                    <div class="form-group">
                        <label for="teachername">Movie title</label>
                        <input type="text" class="form-control" id="name" name="MN"
                               placeholder="enter actor name ...">
                    </div>


                    <div align="right">
                        <input type="submit" class="btn btn-default" name="ADD" value="SEARCH">
                    </div>
                </form>
            </div>
        </div>
